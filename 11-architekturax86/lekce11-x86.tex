...
\textbf{8086} -- A16 F20 (1978) první IBM PC (8088 - 1979) \\
\textbf{80286} -- A16 F24 (1982) protected mode\\
\textbf{80386} -- A32 F32 (1985) stránkování\\
\textbf{80486} -- A32 F32 (1989) pipelining, FPU, cache\\
\textbf{80586} -- A32 F32 (1993) Pentium superscalar\\
\end{column}
\begin{column}{0.48\textwidth}  
\textbf{80686} -- A32 F36 (1995) Pentium Pro PAE, L2 cache, out-of-order \& speculative exec\\
\textbf{IA-64} -- A52 F52 (2001) Itanium 64-bitová verze\\
\textbf{AMD64} -- A40 F40 (2003) Athlonn 64-bitová verze od AMD\\
\textbf{Core2} -- A36 F36 (2006) Intel 64 EM64T, SSSE3, $\mu$op, virtualization
\end{column}
\end{columns}
...
\section{Registry x86}

\begin{frame}[shrink=1.2]
\frametitle{Procesor -- x86/AMD64}
\small
...
mov   $128, %ecx  ; Nastav počet opakovani
...
\texttt{mulX} čím & násobení čísel bez znamének\\
\texttt{divX} čím & dělení čísel bez znamének\\
\texttt{imulX} čím & násobení čísel se znaménky\\
\texttt{idivX} čím & dělení čísel se znaménky\\
\end{tabular}
\end{frame}
...
\begin{frame}[fragile]
\frametitle{Volání funkce -- x86}

\begin{itemize}
\item Volající uloží na zásobník všechny parametry
\item Pořadí ukládání na zísobník je od posledního parametru k prvnímu
\end{itemize}
...
\item Registr ebx nesmí funkce změnit. Pokud ho chce využít musí být uložena původní hodnota na zásobník.
\end{itemize}
