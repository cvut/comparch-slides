...
\includegraphics[width=0.9\textwidth]{bus_arch.pdf}
\end{column}
...
\includegraphics[width=0.8\textwidth]{sdileny_bus.pdf}
\end{center}
...
\includegraphics[width=0.8\textwidth]{PCI_write2.pdf}
...
\includegraphics[width=0.8\textwidth]{PCI_write3.pdf}
...
\includegraphics[width=0.8\textwidth]{PCI_write4.pdf}
