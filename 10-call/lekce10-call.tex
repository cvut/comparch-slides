...
\end{column}   
\begin{column}{0.25\textwidth}  
\includegraphics[width=0.8\textwidth]{rozlozeni_procesu.pdf}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}[fragile,shrink=5]
\frametitle{Překlad funkce s proměnným počtem parametrů}
...
\end{column}
\begin{column}{0.3\textwidth}  
\includegraphics[width=0.7\textwidth]{vaarg_fce_fp.pdf}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
  \includegraphics[width=0.95\textwidth]{irq-and-os.pdf}
\end{center}
