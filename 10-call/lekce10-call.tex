...
\includegraphics[width=0.9\textwidth]{jednoducha_fce-cz.pdf}
\end{column}
\end{columns}
...
\end{column}
\begin{column}{0.35\textwidth}  
\includegraphics[width=0.7\textwidth]{slozita_fce-cz.pdf}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.35\textwidth}  
\includegraphics[width=0.7\textwidth]{slozita_fce_fp-cz.pdf}
\end{column}
\end{columns}
\end{frame}
...
\end{column}   
\begin{column}{0.25\textwidth}  
\includegraphics[width=0.8\textwidth]{rozlozeni_procesu-cz.pdf}
\end{column}
\end{columns}
\end{frame}
...
\includegraphics[width=\textwidth]{overflow_fce-cz.pdf}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.3\textwidth}  
\includegraphics[width=0.7\textwidth]{vaarg_fce_fp-cz.pdf}
\end{column}
\end{columns}
\end{frame}
