...
\begin{enumerate}
  ...
  \end{itemize}
  \item Zkontroluj zda není přerušení nebo výjimka (podrobně v přednášce 9)
...
\phantom{X} & \phantom{X} \\
\hfill \includegraphics[width=1.6cm]{imm_decode.pdf} & provede sestavení bitů konstanty z bitů instrukce a provede znaménkové rozšíření na 32 bitů plnohodnotného čísla se znaménkem \\ 
\end{tabular}
\end{table}
