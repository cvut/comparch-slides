...
\phantom{X} & \phantom{X} \\
\hfill \includegraphics[width=1.6cm]{registry-cz.pdf} & soubor 32 registrů, podle vstupu A1, A2 vybere hodnoty těchto dvou registrů na výstup RD1 a RD2; pokud přijde hodinový signál a je nastaven vstup WE3 (write enable) tak se hodnota WD3 zapíše do registru číslo A3 \\
\phantom{X} & \phantom{X} \\
